...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="signing-content align-items-center py-3">
            <!-- --------------------   SIGN UP ((HEADER)) AREA   ------------------- -->
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group flex-nowrap">
                            <span>
                                <svg viewBox="-42 0 512 512.001" focusable="false"">
                            ...
                            <span class="input-label">{{ __('Full name') }}</span>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-info btn-block">{{ __('Create an account') }}</button>
                    </div>

                    <div class="form-group text-left">
                        <input type="checkbox" name="accepted-policy" id="accepted-policy">

                        <label for="accepted-policy">{{ __('I agree the  policy') }}</label>
                    </div>
                </form>
            </div>
